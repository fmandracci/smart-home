...
#include "main.h"
#include "page103.h"
#include "ui_page103.h"
#include "crosstable.h"

#include "automation.h"

page103::page103(QWidget *parent) :
    page(parent),
    ui(new Ui::page103)
{
    ui->setupUi(this);
...
void page103::changeWidgets(const QString t, const QString T, const QString Tbis, const QString Text, const QString Tsp,
                            int enabled_sensors, int Iam_Tn, bool Tn_isOK, int Tn_heating_status, int Tn_heating_timer, bool Tn_heating, const QColor color)
{
    ...
    // footer
    ui->atcmLabel_T->setVisible(enabled_sensors <= -1);
    ui->atcmLabel_Tsp->setVisible(enabled_sensors <= -1);
    if (enabled_sensors <= -1) {
        ui->atcmLabel_T->setVariable(T);
        ui->atcmLabel_Tsp->setVariable(Tsp);
        ui->atcmLabel_Tsp->setFontColor(color);
    }
    ui->atcmLabel_Tbis->setVisible(enabled_sensors <= -2);
    if (enabled_sensors <= -2) {
        ui->atcmLabel_Tbis->setVariable(Tbis);
    }
    ui->atcmLabel_Text->setVisible(enabled_sensors <= -3);
    if (enabled_sensors <= -3) {
    ...
    ui->atcmGraph->setY1Label(QString::fromUtf8("HR%"));
    ui->atcmGraph->setY2Label(QString::fromUtf8("HR%"));
...
void page103::reload()
{
    ...
    case  1: changeWidgets(LABEL_01, "PLC_T1_humidity", "PLC_T1_humidity_bis", "PLC_T1_humidity_ext", "PLC_T1_humidity_setpoint", PLC_T1_enabled_sensors, PLC_Iam_T1, PLC_T1_isOK, PLC_T1_heating_status, PLC_T1_heating_timer, PLC_T1_heating, COLOR_01); break;
    case  2: changeWidgets(LABEL_02, "PLC_T2_humidity", "PLC_T2_humidity_bis", "PLC_T2_humidity_ext", "PLC_T2_humidity_setpoint", PLC_T2_enabled_sensors, PLC_Iam_T2, PLC_T2_isOK, PLC_T2_heating_status, PLC_T2_heating_timer, PLC_T2_heating, COLOR_02); break;
    case  3: changeWidgets(LABEL_03, "PLC_T3_humidity", "PLC_T3_humidity_bis", "PLC_T3_humidity_ext", "PLC_T3_humidity_setpoint", PLC_T3_enabled_sensors, PLC_Iam_T3, PLC_T3_isOK, PLC_T3_heating_status, PLC_T3_heating_timer, PLC_T3_heating, COLOR_03); break;
    case  4: changeWidgets(LABEL_04, "PLC_T4_humidity", "PLC_T4_humidity_bis", "PLC_T4_humidity_ext", "PLC_T4_humidity_setpoint", PLC_T4_enabled_sensors, PLC_Iam_T4, PLC_T4_isOK, PLC_T4_heating_status, PLC_T4_heating_timer, PLC_T4_heating, COLOR_04); break;
    case  5: changeWidgets(LABEL_05, "PLC_T5_humidity", "PLC_T5_humidity_bis", "PLC_T5_humidity_ext", "PLC_T5_humidity_setpoint", PLC_T5_enabled_sensors, PLC_Iam_T5, PLC_T5_isOK, PLC_T5_heating_status, PLC_T5_heating_timer, PLC_T5_heating, COLOR_05); break;
    case  6: changeWidgets(LABEL_06, "PLC_T6_humidity", "PLC_T6_humidity_bis", "PLC_T6_humidity_ext", "PLC_T6_humidity_setpoint", PLC_T6_enabled_sensors, PLC_Iam_T6, PLC_T6_isOK, PLC_T6_heating_status, PLC_T6_heating_timer, PLC_T6_heating, COLOR_06); break;
    default: changeWidgets("??"    , ""               , ""                   , ""                   , ""                        , 0                     , 0         , 0          , 0                    , 0                   , 0             , COLOR_01);
    }
}

void page103::updateWidgets(int enabled_sensors, int Iam_Tn, bool Tn_isOK, int Tn_heating_status, int Tn_heating_timer, bool Tn_heating, const QColor color)
{
    QString offStylesheet = QString("color: rgb(%1, %2, %3); background-color: rgb(0, 0, 0);").arg(color.red()).arg(color.green()).arg(color.blue());
...
void page103::on_pushButton_trend_clicked()
{
    switch (currentThermostat) {
    case  1: goto_trend_page("trend_H1.csv"); break;
    case  2: goto_trend_page("trend_H2.csv"); break;
    case  3: goto_trend_page("trend_H3.csv"); break;
    case  4: goto_trend_page("trend_H4.csv"); break;
    case  5: goto_trend_page("trend_H5.csv"); break;
    case  6: goto_trend_page("trend_H6.csv"); break;
    default: ;
    }
}

void page103::changeEvent(QEvent * event)
{
